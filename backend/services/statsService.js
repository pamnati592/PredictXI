...
// Competition quality coefficients — based on UEFA league coefficients + world rankings
// Premier League = 1.0 (baseline). Lower leagues get lower multipliers.
// This means a goal scored in the Israeli league counts less than in the PL.
const COMPETITION_QUALITY = {
  ...
  'Süper Lig':             0.68,
  'Brasileirão Série A':   0.72,
  'Championship':          0.70,
  // UEFA European competitions (elite teams from top leagues)
  ...
  'Israeli Premier League':0.52,
  'Ligat Ha\'Al':          0.52,
  'Greek Super League':    0.60,
  'Austrian Football Bundesliga': 0.65,
  'Belgian Pro League':    0.70,
  'Czech First League':    0.60,
  'Polish Ekstraklasa':    0.58,
  'Romanian Liga I':       0.55,
  'Russian Premier League':0.62,
  'Swiss Super League':    0.68,
  // South America
  'Copa Libertadores':     0.75,
  'Argentine Primera División': 0.70,
